...
object Versions {
    ...
    const val MAX_SDK = 2
    const val LIFECYCLE = "2.7.0-alpha01"
    const val ROOM = "2.6.0-alpha03"
    const val FRAGMENT = "1.7.0-alpha02"
    const val NAV = "2.5.1" // NAV_SAFE_ARG
    const val NAV_TESTING = "1.3.0-alpha03"
    const val JUNITX = "1.2.0-alpha01"
    const val TESTX = "1.6.0-alpha01"
...
object Dependencies {
    ...
    const val GLIDE_RUNTIME              = "com.github.bumptech.glide:glide:4.15.1"
    ...
    const val TEST_RULES                 = "androidx.test:rules:1.6.0-alpha01"
    ...
    const val CRASH                      = "com.google.firebase:firebase-crashlytics:18.4.0"
