...
import com.khalid.hamid.githubrepos.utilities.delegates.FragmentViewCallbackProvider
import com.khalid.hamid.githubrepos.utilities.delegates.GetViewModelProvider
import com.khalid.hamid.githubrepos.utilities.delegates.OnViewCreatedListener
import com.khalid.hamid.githubrepos.utilities.delegates.autoClearDialog
import com.khalid.hamid.githubrepos.utilities.extentions.orZero
import com.khalid.hamid.githubrepos.utilities.extentions.safeNavigate
...
import com.khalid.hamid.githubrepos.utilities.toolbar.ToolbarConfig
import com.khalid.hamid.githubrepos.utilities.toolbar.ToolbarMenuConfig
import com.khalid.hamid.githubrepos.utilities.toolbar.getBaseToolbarMenuOption
            ...
            vm.navigateToLiveEvent.observeEvent(viewLifecycleOwner) { navDir ->
                ...
                when (navDir) {
                    is CustomNavDirection.NativeNavDirection -> {
                        if (navDir.result != null) navigateWithResult(
                            navDir.navDirections,
                            navDir.result?.first.orEmpty(),
                            navDir.result?.second ?: Any()
                        ) else {
